...
var _user$project$Hello$model = {name: ''};
var _user$project$Hello$Model = function (a) {
	return {name: a};
};
var _user$project$Hello$NewName = function (a) {
	return {ctor: 'NewName', _0: a};
};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Hello$NewName),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
